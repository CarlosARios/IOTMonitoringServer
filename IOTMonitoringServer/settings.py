...
# debe ir IP publica del visualizador 
ALLOWED_HOSTS = ["localhost", "98.80.247.90", "34.225.72.25"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "98.95.143.89",  # Dirección IP de la base de datos
